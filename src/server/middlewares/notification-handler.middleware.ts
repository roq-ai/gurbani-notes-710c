...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #12345 has been placed by customer John Doe.create': {
    roles: ['administrator', 'registered-user'],
    key: 'order_created',
    tenantPath: [],
    userPath: [],
  },
  'Payment of $100 has been received from customer John Doe for Order #12345.create': {
    roles: ['administrator', 'registered-user'],
    key: 'payment_received',
    tenantPath: [],
    userPath: [],
  },
  'Inventory level for product ABC has fallen below the threshold.update': {
    roles: ['administrator'],
    key: 'inventory_low',
    tenantPath: [],
    userPath: [],
...
const tenantRoles: string[] = ['administrator', 'registered-user', 'guest-user'];
