...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Gurbani Notes`}</title>

        <meta
          name="description"
          content="Gurbani Notes - Empowering your spiritual journey with interactive Sikh Scriptures. Sign up, read, markup, comment, and take notes with toggleable translations and transliterations."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1626260896394-18d8c79d8e41?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxTaWtoJTIwU2NyaXB0dXJlc3xlbnwwfHx8fDE2OTcwMDI5NDB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@narinder85?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`NARINDER PAL`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Gurbani Notes - Empowering your spiritual journey with interactive Sikh Scriptures. Sign up, read, markup, comment, and take notes with toggleable translations and transliterations.`}
            </Text>
            <Box
